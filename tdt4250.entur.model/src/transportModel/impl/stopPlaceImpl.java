...
public class stopPlaceImpl extends MinimalEObjectImpl.Container implements stopPlace {
	...
	protected EClass eStaticClass() {
		return TransportModelPackage.Literals.STOP_PLACE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TransportModelPackage.STOP_PLACE__NAME, oldName, name));
	}
