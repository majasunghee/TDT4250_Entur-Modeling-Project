 ...
 * @generated
 */
public class TransportModelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TransportModelPackage.TRANSPORT_ORG: {
				transportOrg transportOrg = (transportOrg)theEObject;
				T result = casetransportOrg(transportOrg);
			...
			case TransportModelPackage.JOURNEY_PATTERNS: {
				journeyPatterns journeyPatterns = (journeyPatterns)theEObject;
				T result = casejourneyPatterns(journeyPatterns);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>transport Org</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>transport Org</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casetransportOrg(transportOrg object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>journey Patterns</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>journey Patterns</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casejourneyPatterns(journeyPatterns object) {
		return null;
	}
